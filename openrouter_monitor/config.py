...
def _parse_state(raw_state: object) -> StateConfig:
    ...
    trends_path = _require_str(raw_state.get("trends_path", "data/balance_trends.json"), "state.trends_path")
    return StateConfig(users_path=users_path, runtime_path=runtime_path, trends_path=trends_path)
